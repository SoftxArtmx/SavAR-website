...
Cuánto gana, ni tampoco cuánto lleva del sprint'" linkGit={gitLinks["LEONARDO"]} linkIg = {igLinks["LEONARDO"]} linkLkdn = {lkdnLinks["LEONARDO"]}/></Carousel.Slide>
        <Carousel.Slide><Member puesto="Developer" title="Carlos Medina" imgSrc={pfpCM} description="'Mi mamá me dio la vida, Lamia las ganas de vivirla'" linkGit={gitLinks["CARLOS"]} linkIg = {igLinks["CARLOS"]} linkLkdn = {lkdnLinks["CARLOS"]}/></Carousel.Slide>
        ...
        <Carousel.Slide><Member puesto="CUM" title="Diego Muñoz" imgSrc={imagenFun1} description="'No te preocupes tanto por el futuro... A lo mejor ni llegas'" linkGit={gitLinks["REDE"]} linkIg = {igLinks["REDE"]} linkLkdn = {lkdnLinks["REDE"]}/></Carousel.Slide>
        <Carousel.Slide><Member puesto="RookieAllStar" title="Rodrigo Mendez" imgSrc={imagenFun1} description="'Quesocrazy quote'" linkGit={gitLinks["RODRI"]} linkIg = {igLinks["RODRI"]} linkLkdn = {lkdnLinks["RODRI"]}/></Carousel.Slide>
      </Carousel>
    </div>
    </>
  )
